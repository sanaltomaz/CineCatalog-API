...
### Pré-requisitos
1. Crie uma conta em [omdbapi.com](https://www.omdbapi.com)
2. Confirme seu email para ativar a API_KEY
3. Copie sua API_KEY
...
ENDERECO=http://www.omdbapi.com
```

2. Certifique-se de que as variáveis estão configuradas corretamente
